...
namespace Pong
{
    class Program : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if(xDaBola < -ClientSize.Width / 2 || xDaBola > ClientSize.Width / 2) // Situação Gol
            {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            DesenharRetangulo(xDoJogador1(), yDoJogador1, larguraDosJogadores(), larguraDosJogadores(), 1.0f, 0.0f, 0.0f);
            DesenharRetangulo(xDoJogador2(), yDoJogador2, larguraDosJogadores(), larguraDosJogadores(), 0.0f, 0.0f, 1.0f);
